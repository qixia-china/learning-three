<template>
  <div id="box_root">
    <div></div>
    <div id="box" width="250px" height="290px"></div>
  </div>
</template>
...
function createPanel() {
  ...
  crossFadeControls.push(folder4.add(settings, 'from walk to idle').name('从行走到待机'))
  crossFadeControls.push(folder4.add(settings, 'from idle to walk').name('从待机到行走'))
  crossFadeControls.push(folder4.add(settings, 'from walk to run').name('从行走到跑步'))
  crossFadeControls.push(folder4.add(settings, 'from run to walk').name('从跑步到行走'))
